const levelOne = [
  ...
  {
    header: '<h1>Level 1</h1><h3>How it works</h3>',
  ...
  {
    header: '<h1>Level 1</h1><h3>First of all</h3>',
  ...
  {
    header: "<h1>Level 1</h1><h3>Display: flex; </h3>",
    text: `Bom, vamos começar!
    Primeiro, vamos aprender a usar flexbox a partir de propriedades`
  }
];
