...
puts 'Creating level'
level3 = Level.new(id: 3, name: "Level 3", description: "Flex-direction", correction: ["display: *flex;","flex-direction: *column;"], difficulty: "medium")
level3.save!
puts 'Finished'
...
puts 'Creating example'
cards = Example.new(level_id: 3, target: "querySelector('.cards-ghosts')")
cards.content = '<div class="navbar-ex d-flex">
<img class="logo" src="/images/pacman-logo.png">
<ul class="d-flex">
  <li><a href="#" onclick="return false">HOME</a></li>
  <li><a href="#" onclick="return false">ABOUT</a></li>
